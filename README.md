...
You can easy use the **koppa-core.2.0.7.min.js** in your HTML with the **script-tag**.
...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="https://koppajs.s3.eu-central-1.amazonaws.com/koppa-core.2.0.7.min.js"></script>
  </head>
